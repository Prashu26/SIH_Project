...
const Hero = () => {
    ...
    const stats = [
        { label: t('certificatesIssued'), value: 15420, icon: 'bx-certificate' },
        { label: t('verifiedInstitutions'), value: 245, icon: 'bx-buildings' },
        { label: t('successfulVerifications'), value: 89650, icon: 'bx-shield-check' }
    ];
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8 text-center lg:text-left">
                        ...
                        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-md border border-blue-500/30 rounded-full px-6 py-3">
                            ...
                            <span className="text-sm font-medium text-gray-300">{t('blockchainPoweredCredentialing')}</span>
                        </div>
